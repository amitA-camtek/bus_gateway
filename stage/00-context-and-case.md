...
| T3 | AOI_Main **hosts** a gRPC server (:50055) on EOL Grpc.Core | Unauthenticated network listener inside the operator app; dead runtime in the hub |
...
| No externally-reachable internal listeners; one audited door | T3 | :5005 retired; :50055 contained early (gateway proxy) then deleted; SEMI-E187-class posture |
